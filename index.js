...
<body>
  <div class="container"> <!--Main container for the project -->
    ...
    <div class="col footer text-white text-center rounded-bottom">
      <ul> 
        <li>
          <a href="https://github.com/MpShafransky" target="_blank"><i class="fab fa-github"></i></a></li>
        <li>
          <a href="https://www.linkedin.com/in/matthew-shafransky-7a7118212/" target="_blank"></a></li>
        <li>
          <a href="mailto:mpshafransky@gmail.com"><i class="fas fa-envelope-open" aria-hidden="true"> - Email</i></a>
        </li>
        <li>
          <i class="fas fa-mobile-alt" aria-hidden="true"> - Phone: (203) 555 1234</i>
      </li>
      </ul>
